...
describe('WorkflowHistoryResolve', () => {
  ...
  beforeEach(() => {
    ...
    resolver = new WorkflowHistoryResolve(mockNeedApprService, mockConfigSvc)
  ...
  it('should resolve with user ID from route params', () => {
    ...
    mockNeedApprService.getWfHistoryByAppId.mockReturnValue(of(expectedData))
    ...
    result.subscribe(response => {
      expect(mockNeedApprService.getWfHistoryByAppId).toHaveBeenCalledWith(expectedUserId)
  ...
  it('should handle error and return error response', () => {
    ...
    mockNeedApprService.getWfHistoryByAppId.mockReturnValue(throwError(expectedError))
  ...
  it('should handle case when userProfile is not defined', () => {
    ...
    // Assert
    result.subscribe(response => {
      expect(mockNeedApprService.getWfHistoryByAppId).toHaveBeenCalledWith('')
      expect(response).toEqual({ data: expectedData, error: null })
    })
  })
