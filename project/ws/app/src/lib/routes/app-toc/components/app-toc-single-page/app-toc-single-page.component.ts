...
import { ConnectionHoverService } from '@ws-widget/collection/src/lib/_common/connection-hover-card/connection-hover.servive'
import { NsContent, NsAutoComplete } from '@ws-widget/collection/src/public-api'
...
export class AppTocSinglePageComponent implements OnInit, OnChanges, OnDestroy {
  ...
  private initData(data: Data) {
    ...
    if (this.content && this.content[this.compentencyKey]) {
      ...
      this.content[this.compentencyKey] = this.content[this.compentencyKey] // NOSONAR
