...
import { SkeletonLoaderModule } from '@ws-widget/collection/src/lib/_common/skeleton-loader/skeleton-loader.module'
import { ContentTocModule } from '@ws-widget/collection/src/lib/_common/content-toc/content-toc.module'
import { ShareTocModule } from './share-toc/share-toc.module'
import { TocKpiValuesModule } from '@ws-widget/collection/src/lib/_common/content-toc/toc-kpi-values/toc-kpi-values.module'
import { MicroSurveyModule } from '@sunbird-cb/micro-surveys'
import { CardContentV2Module } from '@ws-widget/collection/src/lib/card-content-v2/card-content-v2.module'
import { ConnectionNameModule } from '@ws-widget/collection/src/lib/_common/connection-name/connection-name.module'
import { CertificateDialogModule } from '@ws-widget/collection/src/lib/_common/certificate-dialog/certificate-dialog.module'
import { ConfirmDialogModule } from '@ws-widget/collection/src/lib/_common/confirm-dialog/confirm-dialog.module'
import { KarmaPointsModule } from '@ws-widget/collection/src/lib/_common/content-toc/karma-points/karma-points.module'
import { TipsForLearnerModule } from '@ws-widget/collection/src/lib/_common/tips-for-learner/tips-for-learner.module'
...
import { SlidersDynamicModule } from '@ws-widget/collection/src/lib/sliders-dynamic/sliders-dynamic.module'
